...
export const companyAPI = {
  getAll: () => apiClient.get('companies/', { params: { page_size: 1000 } }),
...
export const paymentFormAPI = {
  getAll: () => apiClient.get('payment-forms/', { params: { page_size: 1000 } }),
...
export const expenseTypeAPI = {
  getAll: () => apiClient.get('expense-types/', { params: { page_size: 1000 } }),
